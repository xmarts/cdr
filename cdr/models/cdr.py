...
class Cdr(models.Model):
    ...
    inicio=fields.Char(string="Inicio",help="Hora de inicio de llamda")
    fin=fields.Char(string="Fin",help="Hora de termino de la llamada")
    ...
    tipodestino=fields.Selection([('800 INTERNACIONAL','800 INTERNACIONAL'),('800 NACIONAL','800 NACIONAL'),('LD INTERNACIONAL','LD INTERNACIONAL'),
                                   ...
                                   ('LD NACIONAL','LD NACIONAL'),('LD NACIONAL CELULAR','LD NACIONAL CELULAR'),('LOCAL','LOCAL'),('LOCAL CELULAR','LOCAL CELULAR')],
    ...
    subscriptionid=fields.Many2one("sale.subscription",string="Contrato de servicio",help='Relacion a contrato')
    subscriptionlineid=fields.Many2one("sale.subscription.line",string="Linea de contrato",help='Relacion al contrato')
    fechafactura=fields.Date(string="Fecha de Factura",help="Fecha de Facturación relacionada")
    computed  = fields.Boolean('Procesado', help='Indica si el registro fue procesado',default=False)